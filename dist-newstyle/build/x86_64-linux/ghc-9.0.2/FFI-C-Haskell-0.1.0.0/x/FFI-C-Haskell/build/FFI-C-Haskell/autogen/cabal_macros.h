...
/* package FFI-C-Haskell-0.1.0.0 */
#ifndef VERSION_FFI_C_Haskell
#define VERSION_FFI_C_Haskell "0.1.0.0"
#endif /* VERSION_FFI_C_Haskell */
#ifndef MIN_VERSION_FFI_C_Haskell
#define MIN_VERSION_FFI_C_Haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FFI_C_Haskell */
...
#define CURRENT_COMPONENT_ID "FFI-C-Haskell-0.1.0.0-inplace-FFI-C-Haskell"
